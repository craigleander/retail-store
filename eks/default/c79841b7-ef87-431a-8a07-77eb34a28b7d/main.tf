...
module "stackgen_095da51f-f927-564a-bd85-c0d8243c8751" {
  source                     = "./modules/aws_elasticache_replication_group"
  apply_immediately          = null
  at_rest_encryption_enabled = "false"
  auth_token                 = var.auth_token_095da51f-f927-564a-bd85-c0d8243c8751
...
module "stackgen_159c8679-df19-51cd-93b4-fd05b6179c6a" {
  ...
  encryption_config = [{
    provider = [{
      key_arn = "arn:aws:kms:us-east-1:339712749745:key/18b0c4ac-74ba-4bd2-aa9d-8fe2a9222af6"
    }]
    resources = ["secrets"]
  }]
  ...
  role_arn              = "arn:aws:iam::339712749745:role/retail-store-cluster-20251006122337416100000002"
  storage_config        = []
  tags = {
    created-by       = "retail-store-sample-app"
    environment-name = "retail-store"
  ...
  vpc_config = [{
    cluster_security_group_id = "sg-02b5aa518b13ff032"
    endpoint_private_access   = true
    endpoint_public_access    = true
    public_access_cidrs       = ["0.0.0.0/0"]
    security_group_ids        = ["sg-08fcf71e7ff9e5810"]
    subnet_ids                = ["subnet-03075069b8559b824", "subnet-0367501afc74e2ef5", "subnet-0c2d0b0d426dad687"]
...
module "stackgen_3c54d636-ef2e-53d5-961a-a75c24d14a6c" {
  ...
  db_name                               = "orders"
  db_subnet_group_name                  = module.stackgen_efa17626-f47d-5472-b82c-6a4b0568c118.name
  ...
  identifier                            = "retail-store-orders-one"
  identifier_prefix                     = ""
  ...
  parameter_group_name                  = "retail-store-orders-20251006122337417000000003"
  password                              = null
  ...
  username               = "root"
  vpc_security_group_ids = ["sg-00a5cb4dac2a23a30"]
}
...
module "stackgen_46a2d493-7cf5-51a8-ab92-336060016b39" {
  source            = "./modules/aws_api_gateway_rest_api"
  body              = null
...
module "stackgen_613abe51-1a90-585a-8628-af7440e9c232" {
  source                                = "./modules/aws_db_instance"
  allocated_storage                     = 1
  allow_major_version_upgrade           = null
  apply_immediately                     = null
  ...
  customer_owned_ip_enabled             = false
  db_name                               = "catalog"
  db_subnet_group_name                  = module.stackgen_9b8f5194-5de9-5790-ae90-f94929918b9d.name
  dedicated_log_volume                  = false
  delete_automated_backups              = true
  deletion_protection                   = false
  domain                                = ""
  ...
  final_snapshot_identifier             = null
  iam_database_authentication_enabled   = false
  identifier                            = "retail-store-catalog-one"
  identifier_prefix                     = ""
  instance_class                        = "db.t3.medium"
  iops                                  = 0
  kms_key_id                            = "arn:aws:kms:us-east-1:339712749745:key/102d37c1-0438-43b9-a8cc-8302cfa365cb"
  ...
  parameter_group_name                  = "retail-store-catalog-20251006122337417700000004"
  password                              = null
  performance_insights_enabled          = false
  performance_insights_kms_key_id       = ""
  performance_insights_retention_period = 0
  ...
  upgrade_storage_config = null
  username               = "root"
  vpc_security_group_ids = ["sg-0d8f6245991c776a4"]
}
...
module "stackgen_8918ec8f-3358-5f1e-b7d2-c8a8fa3af794" {
  ...
  name                       = "k8s-ui-ui-a0335acb8e"
  security_groups = [
    module.stackgen_234aaf5b-781d-523f-8331-71781c8201eb.id,
    module.stackgen_788887e6-7a66-512d-bd2b-72720deeb7ab.id,
  ]
  subnets = ["subnet-00116189b91af5f93", "subnet-08c9ac5bb4715377b", "subnet-0b4f7e7268e5e0425"]
  tags = {
    "elbv2.k8s.aws/cluster"    = "retail-store"
...
module "stackgen_9e9561a4-205c-52bb-aac2-ab94bb6f1b8a" {
  ...
  logging_config = [{
    ...
    log_format            = "Text"
    log_group             = "/aws/lambda/basicauth"
    system_log_level      = ""
  }]
  memory_size                        = 128
  package_type                       = "Zip"
  ...
  role                               = module.stackgen_edd19903-9222-5fc5-8d98-8fb1a904a03e.arn
  runtime                            = "python3.8"
  s3_bucket                          = null
  s3_key                             = null
  skip_destroy                       = false
...
module "stackgen_b27415b7-5e19-54e0-ae24-5b1ba46090f6" {
  source                       = "./modules/aws_elasticache_cluster"
  apply_immediately            = null
  auto_minor_version_upgrade   = "true"
  availability_zone            = "us-east-1b"
  az_mode                      = "single-az"
  cluster_id                   = "retail-store-checkout-001"
  engine                       = "redis"
  engine_version               = "4.0.10"
  final_snapshot_identifier    = null
  ip_discovery                 = "ipv4"
  ...
  replication_group_id         = module.stackgen_095da51f-f927-564a-bd85-c0d8243c8751.id
  security_group_ids           = ["sg-08def4ffc448d77da"]
  snapshot_arns                = null
  snapshot_name                = null
  snapshot_retention_limit     = 0
  snapshot_window              = "06:30-07:30"
  subnet_group_name            = "retail-store-checkout"
  tags = {
    Name             = "retail-store-checkout"
    created-by       = "retail-store-sample-app"
    environment-name = "retail-store"
...
module "stackgen_e1f239a0-4128-5439-b4a8-53059b2fcf01" {
  ...
  name                              = "task-processing-queue.fifo"
