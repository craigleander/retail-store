resource "aws_security_group_rule" "this" {
  ...
  source_security_group_id = (!var.self && length(var.cidr_blocks) == 0 && length(var.ipv6_cidr_blocks) == 0 && var.source_security_group_id != null) ? var.source_security_group_id : null
}